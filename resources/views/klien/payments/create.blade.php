...
<!-- Page header -->
		<div class="page-title d-flex">
			<h4><span class="font-weight-semibold">Home</span> - Pembayaran Tagihan</h4>
		...
		<div class="card-body">
			<form id="form_payment" class="form-validate-jquery" action="{{ route('paymentclients.store')}}" method="post">
				...
				<fieldset class="mb-3">
					...
					<input type="hidden" name="tagihan_id" value="{{ $tagihan }}">
                    ...
                    <div class="form-group row">
						...
						<div class="col-lg-10">
                            <input type="hidden" name="rdtagihan" value="1">
                            <input type="text" name="tagihan" id="tagihan_id" class="form-control border-teal border-1" data-jmlbayar="{{ $tagihan->jml_terbayar }}" data-tagihan="{{$tagihan->total}}" value="{{ $tagihan->invoice }} (Rp {{number_format($tagihan->total, 0, ',', ',')}})" readonly>
                            <input type="hidden" name="rekap_tagihan_id" id="rekap_tagihan_id" value="{{ $tagihan->id }}">
						</div>
					</div>
					<div class="form-group row">
				...
				<div class="text-right">
                    <a href="{{ url('/tagihanuser') }}" class="btn bg-slate"><i class="icon-undo2 mr-2"></i>Kembali</a>
