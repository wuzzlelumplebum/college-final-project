...
<!-- Page header -->
		<div class="page-title d-flex">
			<h4><span class="font-weight-semibold">Home</span> - Data Uang Muka Tagihan {{ $user->nama }}</h4>
			...
			<tbody>
				...
				<td align="center">
					@if (Auth::user()->role > 20)
						...
						@else
						<a href="{{ route('bayardpuser',$tagihan->id)}}">
					...
					<div class="list-icons">
						<div class="dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right">
								<a href="{{ route('bayardpuser',$tagihan->id)}}" class="dropdown-item"><i class="icon-pencil7"></i> Bayar</a>
							</div>
						</div>
					</div>
					@endif
