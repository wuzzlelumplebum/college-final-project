	...
	<div class="content">
		...
		<div class="card" style="border-radius: 10px">
			<div class="card-header header-elements-inline">
				<a href="{{ route('pengeluarans.create')}}"><button type="button" class="btn btn-success rounded-round" style="background: #26a69a"><i class="fa fa-plus" style="font-size:12px"></i>&nbsp Tambah</button></a>
				<a href={{ url('export_excel_pengeluaran')}} target="_blank"><button class="btn btn-success rounded-round" style="background: #26a69a"><i class="icon-file-excel mr-2"></i> Export Excel</button></a>
